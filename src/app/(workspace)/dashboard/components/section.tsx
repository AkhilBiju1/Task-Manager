    ...
    return (
        <section className=" col-span-10 row-span-full">
            <div className=" bg-blue-50 h-screen grid grid-cols-12 gap-4 grid-rows-12 p-4">
                <h1 className="text-2xl col-span-full row-span-1 mt-2 font-semibold ">Welcome <span className="text-blue-700 capitalize">{username}</span>! Here's Your Dashboard</h1>
